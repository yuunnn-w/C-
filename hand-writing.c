...
#include < stdio.h > #include < stdlib.h > #include < math.h > #include < string.h > #include < windows.h > #include < time.h > #include < conio.h > #define SAMPLE_NUM 30 //宏定义每个数字的样本个数，可以修改
